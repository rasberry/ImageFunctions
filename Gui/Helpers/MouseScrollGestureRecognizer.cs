...
// public class MouseScrollGestureRecognizer : ScrollGestureRecognizer
// {
// 	protected override void PointerPressed(PointerPressedEventArgs e)
// 	{
// 		//var p = new Pointer(e.Pointer.Id, PointerType.Pen, e.Pointer.IsPrimary);
// 		//var x = new PointerPressedEventArgs(e.Source, p, e., 
// 		//var x = e with { Pointer = p };
// 		e.Pointer.Type = PointerType.Pen;

// 		Trace.WriteLine($"PointerPressed {e.Pointer.Type}");
// 		base.PointerPressed(e);
// 	}
// }

public class MouseScrollGestureRecognizer : GestureRecognizer
{
	static MouseScrollGestureRecognizer()
	{
