...
public class Function : IFunction
{
	...
	public bool Run(string[] args)
	{
		...
		var prog = Context.Progress;
		var token = Context.Token;

		switch(O.Spear) {
		case Graphic.First_Twist1:
			First.Twist1(img, img.Width, img.Height, prog, token); break;
		case Graphic.First_Twist2:
			First.Twist2(img, img.Width, img.Height, prog, token); break;
		case Graphic.First_Twist3:
			First.Twist3(img, img.Width, img.Height, prog, token); break;
		case Graphic.Second_Twist3a:
			Second.Twist3(img, dlf, img.Width, img.Height, 0, prog, token); break;
		case Graphic.Second_Twist3b:
			Second.Twist3(img, dlf, img.Width, img.Height, 1, prog, token); break;
		case Graphic.Second_Twist3c:
			Second.Twist3(img, dlf, img.Width, img.Height, 2, prog, token); break;
		case Graphic.Second_Twist4:
			Second.Twist4(img, dlf, img.Width, img.Height, prog, token); break;
		case Graphic.Third:
			Third.Twist1(img, dlf, img.Width, img.Width, O.RandomSeed, prog, token); break;
		case Graphic.Fourth:
			Fourth.Draw(img, dlf, img.Width, img.Height, O.RandomSeed, prog, token); break;
		}
