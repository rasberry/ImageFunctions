...
public sealed class Options : IOptions, IUsageProvider
{
	...
	public Usage GetUsageInfo()
	{
		var u = new Usage {
			...
			Parameters = [
				new UsageOne<DrawModeKind>(1, "-m", "Choose drawing mode (default Plain)") { Default = DrawModeKind.Plain },
				...
				new UsageOne<SweepKind>(1, "-w", "Tweak the processing to avoid getting stuck at a dead-end (default Resize)") { Default = SweepKind.Resize }
			],
			EnumParameters = [
