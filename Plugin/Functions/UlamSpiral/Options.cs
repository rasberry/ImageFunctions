	...
	public Usage GetUsageInfo()
	{
		var u = new Usage {
			...
			Parameters = [
				...
				new UsageOne<ColorRGBA>(1, "-c1", "Color to be used depending on mode. (optional)"),
				new UsageOne<ColorRGBA>(1, "-c2", "Color to be used depending on mode. (optional)"),
				new UsageOne<ColorRGBA>(1, "-c3", "Color to be used depending on mode. (optional)"),
				new UsageOne<ColorRGBA>(1, "-c4", "Color to be used depending on mode. (optional)"),
