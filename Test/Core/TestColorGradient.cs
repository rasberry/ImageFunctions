...
public class TestColorGradient
{
	...
	[DataRow(0.9, 0.9)]
	[DataRow(1.0, 1.0)]
	public void TestMonochromeGradient(double index, double egray)
	{
		var grad = new MonochromeGradient();
		var c1 = new ColorRGBA(egray, egray, egray, 1.0);
