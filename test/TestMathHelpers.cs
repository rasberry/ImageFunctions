...
namespace test
{
	...
	public class TestMathHelpers
	{
		...
		{
			var (x,y) = MathHelpers.LinearToXY(p,10,10,10);
			Assert.AreEqual(exx,x);
			Assert.AreEqual(exy,y);
		}
		...
		{
			var p = MathHelpers.XYToLinear(x,y,10,10,10);
			Assert.AreEqual(exp,p);
		}
		...
		{
			var (x,y) = MathHelpers.DiagonalToXY(p,10,10);
			Assert.AreEqual(exx,x);
			Assert.AreEqual(exy,y);
		}
		...
		{
			var p = MathHelpers.XYToDiagonal(x,y,10,10);
			Assert.AreEqual(exp,p);
		}
		...
		{
			var (x,y) = MathHelpers.SpiralSquareToXY(p,10,10);
			Assert.AreEqual(exx,x);
			Assert.AreEqual(exy,y);
		}
		...
		{
			var p = MathHelpers.XYToSpiralSquare(x,y,10,10);
			Assert.AreEqual(exp,p);
		}
